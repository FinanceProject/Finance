...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                ...
                                                <img src="{{asset("lib/dist/img/user2-160x160.jpg")}}" class="img-circle"
                                                alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset("lib\dist\img\user4-128x128.jpg")}}" class="img-circle"
                                                alt="User Image">
                                            </div>
                                            <h4>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset("/public")}}/img/user.jpg" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{$fullname or 'USER'}}- Web Developer
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class=" list_staff @yield('list_staff')"><a href="#"><i class="fa fa-list-ul"></i> Danh sách nhân viên</a></li>
                        <li><a class="add_staff @yield('add_staff')" href="#"><i class="fa fa-user-plus"></i> Thêm thành viên</a></li>
                        <li class="change_password_staff @yield('change_password_staff')"><a href="#"><i class="fa fa-gear"></i> Đổi Mật Khẩu Thành Viên</a></li>
                    </ul>
                </li>
                ...
                <li class=" treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class=" list_request @yield('list_request')"><a href="#"><i class="fa fa-list-ul"></i> Danh sách yêu cầu</a></li>
                        <li><a class="add_staff @yield('add_staff')" href="#"><i class="fa fa-circle-o"></i> Mục liên quan tới yêu cầu</a></li>
                        <li class="change_password_staff @yield('change_password_staff')"><a href="#"><i class="fa fa-gear"></i> Mục liên quan tới yêu cầu</a></li>
                    </ul>
                </li>

                <li class=" treeview">
                    <a href="">
                        <i class="fa fa-user-secret"></i> <span>Quản lý khách hàng</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li class=" list_customer @yield('list_customer')"><a href="#"><i class="fa fa-list-ul"></i> Danh sách khách hàng</a></li>
                        <li><a class="add_staff @yield('add_staff')" href="#"><i class="fa fa-circle-o"></i> Mục liên quan tới khách hàng</a></li>
                        <li class="change_password_staff @yield('change_password_staff')"><a href="#"><i class="fa fa-circle-o"></i> Mục liên quan tới khách hàng</a></li>
                    </ul>
                </li>

                <li class=" treeview">
                    <a href="">
                        <i class="fa fa-bank"></i> <span>Quản lý Ngân hàng</span>
                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li class=" list_bank @yield('list_bank')"><a href="#"><i class="fa fa-list-ul"></i> Danh sách Ngân hàng</a></li>
                        <li><a class="add_bank @yield('add_bank')" href="#"><i class="fa fa-circle-o"></i> Thêm Ngân Hàng</a></li>
                        <li class="change_password_staff @yield('change_password_staff')"><a href="#"><i class="fa fa-circle-o"></i> Mục liên quan tới Ngân hàng</a></li>
                    </ul>
                </li>
    ...
    <!-- Control Sidebar - THanh menu bên trái-->
